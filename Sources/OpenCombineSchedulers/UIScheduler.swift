...
public struct UIScheduler: Scheduler {
  ...
  public var now: SchedulerTimeType { DispatchQueue.main.ocombine.now }
  public var minimumTolerance: SchedulerTimeType.Stride {
    DispatchQueue.main.ocombine.minimumTolerance
  }
  ...
  public func schedule(options: SchedulerOptions? = nil, _ action: @escaping () -> Void) {
    if DispatchQueue.getSpecific(key: key) == value {
      ...
      DispatchQueue.main.ocombine.schedule(action)
    }
  }
  ...
  public func schedule(
    ...
    DispatchQueue.main.ocombine.schedule(
      after: date,
      tolerance: tolerance,
      options: nil,
      action
